...
public final class PlaytimeAdminUI extends InteractiveCustomUIPage<PlaytimeAdminUI.AdminEventData> {
    ...
    public static final class AdminEventData {
        public static final BuilderCodec<AdminEventData> CODEC = BuilderCodec
                ...
                .addField(new KeyedCodec<>("RewardAction", Codec.STRING), (d, v) -> d.rewardAction = v, d -> d.rewardAction)
                .addField(new KeyedCodec<>("RewardId", Codec.STRING), (d, v) -> d.rewardId = v, d -> d.rewardId)
                .addField(new KeyedCodec<>("@RewardSearch", Codec.STRING), (d, v) -> d.rewardSearch = v, d -> d.rewardSearch)
                .addField(new KeyedCodec<>("@DraftId", Codec.STRING), (d, v) -> d.draftId = v, d -> d.draftId)
                .addField(new KeyedCodec<>("@DraftRequired", Codec.STRING), (d, v) -> d.draftRequired = v, d -> d.draftRequired)
                .addField(new KeyedCodec<>("@DraftCost", Codec.STRING), (d, v) -> d.draftCost = v, d -> d.draftCost)
                .addField(new KeyedCodec<>("@DraftRank", Codec.STRING), (d, v) -> d.draftRank = v, d -> d.draftRank)
                .addField(new KeyedCodec<>("@DraftCommands", Codec.STRING), (d, v) -> d.draftCommands = v, d -> d.draftCommands)
                .addField(new KeyedCodec<>("@DraftBroadcast", Codec.STRING), (d, v) -> d.draftBroadcast = v, d -> d.draftBroadcast)
                .addField(new KeyedCodec<>("@CfgTopLimit", Codec.STRING), (d, v) -> d.cfgTopLimit = v, d -> d.cfgTopLimit)
                .addField(new KeyedCodec<>("@CfgCheckInterval", Codec.STRING), (d, v) -> d.cfgCheckInterval = v, d -> d.cfgCheckInterval)
                .addField(new KeyedCodec<>("@CfgRankupAutoCheck", Codec.STRING), (d, v) -> d.cfgRankupAutoCheck = v, d -> d.cfgRankupAutoCheck)
                .build();
