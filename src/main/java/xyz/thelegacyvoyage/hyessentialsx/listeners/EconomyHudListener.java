...
public final class EconomyHudListener {

    private final EconomyHudManager economyHudManager;

    public EconomyHudListener(@Nonnull EconomyHudManager economyHudManager) {
        this.economyHudManager = economyHudManager;
    }
    ...
    private void onPlayerReady(@Nonnull PlayerReadyEvent event) {
        ...
        world.execute(() -> {
            ...
            economyHudManager.scheduleInitial(playerRef);
        });
    }
    ...
    private void onPlayerDisconnect(@Nonnull PlayerDisconnectEvent event) {
        ...
        economyHudManager.onPlayerDisconnect(playerRef);
    }
}
