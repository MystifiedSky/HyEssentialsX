...
public class ScoreboardMoveUI extends InteractiveCustomUIPage<ScoreboardMoveEventData> {
    ...
    public ScoreboardMoveUI(@Nonnull PlayerRef playerRef,
    ...
    private void applyMove(int deltaX, int deltaY) {
        ...
        scoreboardManager.adjustPlayerOffset(playerRef.getUuid(), adjustedX, adjustedY);
    ...
    private String formatOffsetText() {
        int totalX = scoreboardManager.getResolvedOffsetX(playerRef.getUuid());
        int totalY = scoreboardManager.getResolvedOffsetY(playerRef.getUuid());
        return "Offset: " + totalX + ", " + totalY;
    }
